...
public partial class First_reminder : System.Web.UI.Page
{
    ...
    public void sendemail(string staffid, string name, string mail, string gmmail,string othermail)
    {
        ...
        MyEmailMessage.Subject = "Reminder for your no punch notification（" + staffid + ")";
        ...
        txbody = txbody + "</div>";
        txbody = txbody + " </br>";
        txbody = txbody + " <span style=\"font-family:times;font-size:18px\">Please clear your attendance variance <span style=\"color:red\"><b><i>WITHIN 1 WEEK </i></b></span>from this notification.</span>";
