    ...
    <form id="form1" runat="server">
        ...
        <div class="loginhead">
            ...
            <div style="width: 960px; margin: auto;">
                ...
                <div style="color: white; font-family: AkzidenzGrotesk,Perpetua,Cambria; margin: auto; width: 350px; height: 50px; padding-top: 20px">Cabin Crew Load Factor</div>
            </div>
            ...
            <div class="loginbody">
                ...
                <div class="loginbox">
                    ...
                    <%--        <div>
                            ...
                            <div>
                                <input type="password" placeholder="Management Code" required="required" id="password" runat="server" style="width: 160px; height: 30px; margin-top: 25px; margin-left: 40px" />
                            </div>
