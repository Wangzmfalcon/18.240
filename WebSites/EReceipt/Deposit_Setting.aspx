<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Deposit_Setting.aspx.cs" Inherits="Deposit_Setting" %>
        ...
        <div class="mainbody">
            <div class="bodydiv">
                ...
                <div style="padding-top: 20px; padding-bottom: 20px; font-family: Cambria, Helvetica, sans-serif;">
                    <p class="pagetitle">Desposit Type Setting</p>
                    <span class="clear"></span>
                    <div class="col-md-4">
                        Deposit Type:<asp:TextBox ID="Deposit" runat="server" required="required"></asp:TextBox>
                    </div>
                    <div class="col-md-4">
            ...
            Station Name:<asp:TextBox ID="STATION_NAME" runat="server"></asp:TextBox>--%>
                ...
                <div>
                    ...
                    <asp:Repeater ID="Deposit_table" runat="server">

                        <HeaderTemplate>
                            <table class="grid grid-striped grid-hover" style="width: 50%; margin-left: 0">
                                <tr>
                                    <th>Deposit</th>
                                    <th>Order</th>
