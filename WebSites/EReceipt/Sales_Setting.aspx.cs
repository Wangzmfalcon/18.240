...
public partial class Sales_Setting : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            SqlDataAdapter sda = new SqlDataAdapter("select Trans_Value,Trans_Order from ERS_Trans where Trans_Type='Sales'  order by Trans_Order", SqlHelper.Conn);
            sda.Fill(ds, "Sales");
    ...
    protected void save_Click(object sender, EventArgs e)
    {
        ...
        //检查是否存在
        string SQL_query = " select * from ERS_Trans where Trans_Value='" + Deposit_Type + "'  and Trans_Type='Sales'";
    ...
    protected void delete_Click(object sender, EventArgs e)
    {
        ...
        string SQL_delete = " delete ERS_Trans where Trans_Value='" + Deposit_Type + "' and Trans_Type='Sales' ";
        using (SqlConnection conn = new SqlConnection(SqlHelper.Conn))
        {
