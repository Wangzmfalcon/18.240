...
public partial class Currency_Setting : System.Web.UI.Page
{
    ...
    protected void save_Click(object sender, EventArgs e)
    {
        ...
        string Currency_Type = Currency.Text;
        ...
        //检查是否存在
        string SQL_query = " select * from ERS_Trans where Trans_Value='" + Currency_Type + "'  and Trans_Type='Currency'";
        ...
        using (SqlDataReader rdr = SqlHelper.ExecuteReader(SqlHelper.Conn, CommandType.Text, SQL_query))
        {
            ...
            else if(flag=="Y")
            {
                ...
                parms[0].Value = "Currency";
                parms[1].Value = Currency_Type;
    ...
    protected void delete_Click(object sender, EventArgs e)
    {
        ...
        string SQL_delete = " delete ERS_Trans where Trans_Value='" + Currency_Type + "' and Trans_Type='Currency' ";
        using (SqlConnection conn = new SqlConnection(SqlHelper.Conn))
        {
