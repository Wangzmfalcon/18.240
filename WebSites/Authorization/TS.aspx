<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TS.aspx.cs" Inherits="TS" %>
...
<link href="css/leftmenu.css" rel="stylesheet" type="text/css" />
 ...
 <script src="js/leftmenu.js" type="text/javascript"></script>
    ...
    <title>Training Reminder Setting</title>
...
<p><span class="style2"><strong>Training Reminder Setting</strong></span></p>
    <div style="width:1000px; height=150px;font-size:14px; float:left;">
...
<ul>
<li>Training Expired Date<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>days
