        ...
        <ul>
            ...
            <li><a id="staffs" class="hide" href="Main.aspx" runat="server">Staff Settings</a>
                ...
                <ul>
                    ...
                    <li><a href="Division.aspx" title="Division Setting">Division Setting</a></li>
                    <li><a href="Station.aspx" title="Station Setting">Station Setting</a></li>
                    <li><a href="Title.aspx" title="Title Setting">Title Setting</a></li>
                    <li><a href="Position.aspx" title="Employee Setting">Position </a></li>
            ...
            <li><a id="Training" style="width: 150px" class="hide" href="Main.aspx" runat="server">Training Module</a>

                <ul>
                    <li><a href="Course.aspx" title="Class Setting">Course</a></li>
                    <li><a href="Course_ref_search.aspx" title="Course Setting">Course Reference</a></li>
                    <li><a href="Class_search.aspx" title="Class">Class</a></li>
                    <li><a href="Training_Records_Search.aspx" title="Training Records Search">Training Records</a></li>
                       <li><a href="Training_Alert_Search.aspx" title="Training Alert Search">Training Alert</a></li>
            ...
            <li><a id="Authorss" style="width: 150px" class="hide" href="Main.aspx" runat="server">Staff Search</a>
                
                <ul>
                    <li><a href="AuthorizationSelect.aspx" title="Authorization Search">Authorization</a></li>
                    <li><a href="Training_Alert_Search_Staff.aspx" title="Training Alert Search">Training Alert</a></li>
  

                </ul>
            </li>
            <li><a id="Reminder" style="width: 100px" class="hide" href="RS.aspx" runat="server">Reminder Setting</a>
                <ul>
                    <li><a href="RS.aspx" title="Reminder Setting">Reminder Setting</a></li>
                    <li><a href="ML.aspx" title="Email Setting">Email Setting</a></li>
                    <li><a href="TS.aspx" title="Training Setting">Training Setting</a></li>
                </ul>
            </li>
