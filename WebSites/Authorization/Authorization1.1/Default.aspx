    ...
    <form id="form1" runat="server">
        <div id="layout">
            <div id="systitle">
                ...
                <div class="toptitle">Authorization<span style="font-size: xx-small; font-weight: normal; padding: 5px"></span></div>
                <div id="logoutbt">
                </div>
            </div>
            ...
            <div id="login2">
                <table border="0" cellspacing="0" cellpadding="0" height="250"
                    style="width: 492px">
                    <tr>
                        <td height="38" colspan="2" style="background-color: #F1F1F1; padding: 0 20px; text-align: left; border-bottom: #CCC solid 1px; font-size: 16px;">
                            Login
                            </td>
                            </tr>
                    <tr>
