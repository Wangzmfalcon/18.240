<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Staffin.aspx.cs" Inherits="Staffin" %>
...
<%--                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="Staff NO">
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox3" MaxLength="20" Width="80" runat="server" Text='<%# Bind("StaffName") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Department">
                    <EditItemTemplate>
                        <asp:DropDownList ID="Department" MaxLength="20" Width="80" runat="server" DataValueField='<%# Bind("Department") %>'></asp:DropDownList>
                    </EditItemTemplate>
                    <ItemTemplate>
                    ...
                    <EditItemTemplate>
                        <asp:Dropdownlist ID="Division" MaxLength="20" Width="80" runat="server" DataValueField='<%# Bind("Division") %>'></asp:Dropdownlist>
                    </EditItemTemplate>
                    <ItemTemplate>
                    ...
                    <EditItemTemplate>
                        <asp:Dropdownlist ID="Title" MaxLength="20" Width="80" runat="server" DataValueField='<%# Bind("Title") %>'></asp:Dropdownlist>
                    </EditItemTemplate>
                    <ItemTemplate>
                    ...
                    <ItemTemplate>
                        <asp:Label ID="Label8" runat="server" Text='<%# Bind("DateOfJoin") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                
                                                <asp:TemplateField HeaderText="Lisense">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox5" MaxLength="20" Width="80" runat="server" Text='<%# Bind("License") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="Label5" runat="server" Text='<%# Bind("License") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="LisenseExpired">
                    <EditItemTemplate>
                    ...
                    <ItemTemplate>
                        <asp:Label ID="Label9" runat="server" Text='<%# Bind("LicenseExpired") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
