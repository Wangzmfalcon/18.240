<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Level.aspx.cs" Inherits="Level" %>
...
<div  style="height:30px; text-align:center; color:black; font-size:large"  >
    Level：<asp:TextBox ID="txtName" runat="server"></asp:TextBox>
...
<%--                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="Level">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox2" MaxLength="20" Width="80" runat="server" Text='<%# Bind("Level") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
