...
<div  style="height:30px; text-align:center; color:black; font-size:large"  >
    Rating：<asp:TextBox ID="txtName" runat="server"></asp:TextBox>
...
<%--                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="Rating">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox2" MaxLength="20" Width="80" runat="server" Text='<%# Bind("Range") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="Label2" runat="server" Text='<%# Bind("Range") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
