<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Airmacau3.ascx.cs" Inherits="WebUserControl" %>
...
<div class="logo">    
        <a href="http://www.airmacau.com.mo"><img alt="澳门航空" src="images/logo.gif" 
            border="none" /></a>
