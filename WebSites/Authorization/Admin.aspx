<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin.aspx.cs" Inherits="Department" %>
        ...
        <div id="backpanel">
            ...
            <div id="pagebody">
                ...
                <div id="Contentpanel">
                    ...
                    <div id="rules" style="height: 20px; text-align: left; color: red; font-size: medium"
                        onmouseover="shows()" onmouseout="closed()">
                        Rules

          <div id="f" style="background-color:yellow;color:Background; font-size:medium">
              <div>≥10.Staff Setting </div>
              <div>≥60.Authorization Setting </div>
              <div>≥70.Authorization,Training </div>
              <div>≥100.Admin Setting </div>
                    ...
                    <div style="height: 30px; text-align: center; color: black; font-size: large">
                        Administrator Setting：UserID<asp:TextBox ID="txtName" runat="server"></asp:TextBox>AdminLevel<asp:TextBox ID="txtlevel" runat="server"></asp:TextBox>E-mail<asp:TextBox ID="txtmail" runat="server"></asp:TextBox>
                        <asp:Button ID="btnAdd" runat="server" UseSubmitBehavior="false" Height="25px" OnClick="btnAdd_Click"
                            Text="Add" Width="82px" />
                    ...
                    <div style="text-align: center; color: black;">
                        ...
                        <asp:TextBox ID="TextBox1" MaxLength="20" Width="80" runat="server" Text='<%# Bind("ID") %>'></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderText="UserID">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="TextBox2" MaxLength="20" Width="80" runat="server" Text='<%# Bind("UserID") %>'></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="Label2" runat="server" Text='<%# Bind("UserID") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Admin_Level">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="TextBox3" MaxLength="20" Width="80" runat="server" Text='<%# Bind("Admin_Level") %>'></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="Label3" runat="server" Text='<%# Bind("Admin_Level") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="E-mail">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="TextBoxmail" MaxLength="100" Width="80" runat="server" Text='<%# Bind("Email") %>'></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
