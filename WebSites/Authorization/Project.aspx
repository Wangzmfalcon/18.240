...
<div  style="height:30px; text-align:center; color:black; font-size:large"  >
    Subject：<asp:TextBox ID="txtName" runat="server"></asp:TextBox>Remarks：<asp:TextBox ID="txtremark" runat="server"></asp:TextBox>
...
<%--                    <EditItemTemplate>
                ...
                <asp:TemplateField HeaderText="Subject">
                    ...
                    <ItemTemplate>
                        <asp:Label ID="Label2" Width="80" runat="server" Text='<%# Bind("Project") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Remarks">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBoxRemark" MaxLength="250" Width="200" runat="server" Text='<%# Bind("Remark") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
                        <asp:Label ID="LabelRemark"  Width="200"  runat="server" Text='<%# Bind("Remark") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
