<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeFile="Training_Alert_Search_Staff.aspx.cs" Inherits="Training_Alert_Search" %>
...
<head id="Head1" runat="server">
    ...
    <title>Training Alert Search</title>
    <style type="text/css">
        .searchbox {
            width: 130px;
            height: 20px;
                ...
                <div id="Contentpanel">
                    ...
                    <div style="width: 1000px; margin-left: auto; margin-right: auto;">
                        <table style="margin-left: auto; margin-right: auto;">
                            ...
                            <tr>
                                ...
                                <td>Alert Type: </td>
                                <td>
                                    <asp:DropDownList ID="Alert" runat="server" CssClass="searchbox"></asp:DropDownList>
                                </td>
                                <td>
                    ...
                    <div style="margin-top: 20px">
                        <asp:Repeater ID="Report" runat="server">
                            ...
                            <HeaderTemplate>
                                <table class="datatable" cellspacing="1" cellpadding="3" rules="cols" border="1" id="GridView1" style="border-color: #999999; border-width: 1px; border-style: solid; width: 1000px; border-collapse: collapse; margin: auto">
                                    <tr>
                                        <th>Staff ID</th>
                                        <th>Staff Name </th>
                                        <th>Station</th>
