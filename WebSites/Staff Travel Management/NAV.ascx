        ...
        <div class="navbar">
            <ul>
                ...
                <li id="email" runat="server" class="dropdown">
                    <a href="#" class="dropbtn">Staff Travel Management </a>
                    <div class="dropdown-content">
                        <a href="Staff_Travel_Balance.aspx">Balance Adjustment</a>
                        <a href="Staff_Travel_Records.aspx">Records</a>
                        <a href="Staff_Travel_Entitlement.aspx">Entitlement</a>
